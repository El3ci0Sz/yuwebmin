...
public class ProdutoService{
   ...
   public ProdutoResponseDTO create(ProdutoRequestDTO requestDTO) {
       ...
       if (produto.getItemFixo() == null) produto.setItemFixo(false);
   ...
   public ProdutoResponseDTO findByID(long id){
    Produto produto = produtoRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Produto não encontrado com o ID "+ id));
   ...
   public ProdutoResponseDTO updateOneProduto(long id, ProdutoRequestDTO requestDTO) {
    ...
    Produto produtoExistente = produtoRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Produto não encontrado com o ID "+ id));
   ...
   public void deleteOneProduto(long id){
    ...
    Produto produtoDeletar = produtoRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Produto não encontrado com o ID "+ id));

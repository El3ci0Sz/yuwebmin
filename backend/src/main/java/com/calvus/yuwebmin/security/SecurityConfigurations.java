...
public class SecurityConfigurations {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                return http
                                .cors(Customizer.withDefaults()) // Adicionado apenas para o painel de testes HTML
                                                                 // funcionar (CORS)
                                ...
                                .authorizeHttpRequests(req -> {
                                        ...
                                        req.requestMatchers("/v3/api-docs", "/v3/api-docs/**", "/swagger-ui.html",
                                                        "/swagger-ui/**")
                                                        .permitAll();
                                        ...
                                        req.requestMatchers(HttpMethod.POST, "/produtos/**", "/acompanhamentos/**",
                                                        "/modelos-marmitas/**")
                                                        .hasRole("ADMIN");
                                        req.requestMatchers(HttpMethod.PUT, "/produtos/**", "/acompanhamentos/**",
                                                        "/modelos-marmitas/**")
                                                        .hasRole("ADMIN");
                                        req.requestMatchers(HttpMethod.PATCH, "/produtos/**", "/acompanhamentos/**",
                                                        "/modelos-marmitas/**")
                                                        .hasRole("ADMIN");
                                        req.requestMatchers(HttpMethod.DELETE, "/produtos/**", "/acompanhamentos/**",
                                                        "/modelos-marmitas/**").hasRole("ADMIN");
                                        req.requestMatchers(HttpMethod.GET, "/pedidos/admin").hasRole("ADMIN");
